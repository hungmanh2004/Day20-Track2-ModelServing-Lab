...
|:--|--:|--:|--:|--:|--:|
| Why is goodput more useful than raw throughp... | goodput, paged, radix | 0.0 | 0.1 | 6106.8 | 6107.1 |
| What problem does PagedAttention actually so... | paged, radix, disagg | 0.0 | 0.2 | 4774.8 | 4775.2 |
| When does splitting prefill and decode help?... | disagg, radix, batching | 0.0 | 0.2 | 5017.5 | 5017.8 |

Mean per stage (ms): embed **0.0** · retrieve **0.2** ·
llm **5299.7** · total **5300.0**
